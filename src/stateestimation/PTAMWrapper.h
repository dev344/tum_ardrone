...
private:
    ...
    enum
    {
        ANIM_NONE, ANIM_TOOKKF, ANIM_GOOD, ANIM_INIT, ANIM_LOST, ANIM_FALSEPOS
    } lastAnimSent;
    ...
    TooN::Vector<3> evalNavQue(unsigned int from, unsigned int to,
...
public:
    ...
    void setPTAMPars(double minKFTimeDist, double minKFWiggleDist,
            double minKFDist);
