...
{
    // Prepares a Keyframe from an image. Generates pyramid levels, does FAST detection, etc.
...
void KeyFrame::MakeKeyFrame_Rest()
{
    ...
    static gvar3<double> gvdCandidateMinSTScore(
            "MapMaker.CandidateMinShiTomasiScore",
            MAPMAKER_MIN_SHI_THOMASI_SCORE, SILENT);
